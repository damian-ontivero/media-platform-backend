...
async def test_serie_update__ok(mock_serie_repository, mock_media_finder, mock_event_bus) -> None:
    serie = SerieFactory()
    ...
    updater = SerieUpdater(mock_serie_repository, mock_media_finder, mock_event_bus)
    id = serie.id.value
