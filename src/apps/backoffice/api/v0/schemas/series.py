...
class SerieEpisodeReadSchema(BaseModel):
    ...
    synopsis: str = Field(..., description="Serie Episode Synopsis", examples=["This is an amazing episode"])
...
class SerieSeasonReadSchema(BaseModel):
    ...
    synopsis: str = Field(..., description="Serie Season Synopsis", examples=["This is an amazing season"])
...
class SerieReadSchema(BaseModel):
    ...
    synopsis: str = Field(..., description="Serie Synopsis", examples=["This is an amazing serie"])
