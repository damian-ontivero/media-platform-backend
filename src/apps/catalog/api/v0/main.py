...
from apps.catalog.api.v0.exception import EXCEPTION_TO_HTTP_STATUS_CODE
from apps.catalog.api.v0.routers.health_check import router as health_check_router
from apps.catalog.api.v0.routers.movies import router as movies_router
from apps.catalog.api.v0.routers.series import router as series_router
